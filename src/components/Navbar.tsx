                ...
                <NavBody>
                    <div className="flex flex-1 items-center gap-4 lg:gap-8 justify-between lg:justify-start w-full">
                        ...
                        <Link href="/" className="flex items-center gap-3 group shrink-0 h-full">
                            <div className="h-9 w-9 md:h-10 md:w-10 bg-secondary rounded-xl flex items-center justify-center text-primary font-serif font-bold text-lg md:text-xl group-hover:bg-secondary/95 transition-all shadow-inner shrink-0 pointer-events-auto">
                                M
                            </div>
                                ...
                                <AnimatePresence mode="wait">
                                    {isSearchOpen ? (
                                        <motion.div
                                            ...
                                            className="relative flex items-center bg-white/10 border border-secondary/20 rounded-xl px-2 overflow-hidden h-10"
                                        >
                                        ...
                                        <motion.button
                                            ...
                                            className="group flex flex-row items-center justify-center p-2 rounded-xl hover:bg-white/10 transition-all duration-300 text-secondary/60 hover:text-secondary h-10 w-10 hover:w-36 overflow-hidden"
                                        >
                            ...
                            {user ? (
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className="bg-white/10 hover:bg-white/20 text-secondary h-10 w-10 rounded-xl flex items-center justify-center transition-all cursor-pointer group shadow-lg"
                                    >
