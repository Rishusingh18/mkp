...
export default function ContactPage() {
    return (
        <div className="min-h-screen bg-background-light pt-2 md:pt-12 pb-0">
            {/* 1. TOP SECTION (Info Grid) */}
            <div className="max-w-[1400px] mx-auto px-6 md:px-12 mb-4 lg:mb-6 -mt-4 md:-mt-8 relative z-10 w-full">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-primary mb-2 tracking-tight uppercase text-center">
                    GET IN TOUCH
                </h1>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 lg:gap-16">
                        ...
                        <div className="flex flex-col gap-3 group">
                            ...
                            <div>
                                ...
                                <div className="text-primary/70 text-sm leading-relaxed">
                        ...
                        <div className="flex flex-col gap-3 group">
                            ...
                            <div>
                                ...
                                <div className="text-primary/70 text-sm leading-relaxed break-all">
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-12 mt-20 lg:mt-32">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                    <div className="max-w-md">
                        <h2 className="text-3xl md:text-4xl font-display font-bold text-primary mb-6">Request a Demo</h2>
                        <p className="text-primary/70 leading-relaxed text-lg">
                            Are you interested in partnering with us? Then what do you waiting for? Let's get in touch.
                        </p>
                    </div>
                    ...
                    <div className="w-full">
                        <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-primary ml-2 uppercase tracking-wide">Full Name <span className="text-red-500">*</span></label>
                                <input 
                                    type="text" 
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-primary ml-2 uppercase tracking-wide">Company / Job <span className="text-red-500">*</span></label>
                                <input 
                                    type="text" 
                            ...
                            {/* Email */}
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-primary ml-2 uppercase tracking-wide">Email Address <span className="text-red-500">*</span></label>
                                <input 
                                    type="email" 
                            ...
                            {/* Phone */}
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-primary ml-2 uppercase tracking-wide">Phone Number <span className="text-red-500">*</span></label>
                                <input 
                                    type="tel" 
                            ...
                            <div className="md:col-span-2 mt-4">
                                <button type="submit" className="bg-primary hover:bg-primary-hover text-secondary px-8 py-4 rounded-xl font-bold transition-all shadow-lg hover:shadow-xl w-full sm:w-auto hover:-translate-y-1">
                                    Send Message
                                </button>
                            </div>
                        </form>
